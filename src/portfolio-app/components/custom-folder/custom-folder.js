...
import '../custom-file/custom-file.js';

// custom folder icon fill color: #231f20
class CustomFolder extends PolymerElement {
    ...
    ready() {
        ...
        super.ready();
        this.__folder__ = this.shadowRoot.querySelector('.files');

        // set the height of folder dynamically based on number of files. 
        this.updateStyles({
