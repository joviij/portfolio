...
class FolderBox extends PolymerElement {
  ...
  constructor() {
    ...
    this.__cards__ = null;
    this.cardMap = {};
    this.previousCard = ''; // attach event listener to folder box that will display the correct card when filename is clicked. 
  ...
  connectedCallback() {
    super.connectedCallback(); // Event used to ensure that the page should only show the body after folder box has been rendered. 

    var loadedEvent = new CustomEvent('box-loaded', {
      bubbles: true,
      composed: true
    });
