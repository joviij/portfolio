...
class StyleTransformer {
  ...
  _transformDom(startNode, transformer) {
    ...
    let c$ = startNode.localName === 'template' ? // In case the template is in svg context, fall back to the node
...
let ROOT = ':root';
let SLOTTED = '::slotted';
let SLOTTED_START = new RegExp(`^(${SLOTTED})`); // NOTE: this supports 1 nested () pair for things like
// :host(:not([selected]), more general support requires
// parsing which seems like overkill

let HOST_PAREN = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/; // similar to HOST_PAREN
